            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <span style={{ background: '#f06a35' }} class="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6"></span>
                        <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">Aminul Islam</h2>
                        <p class="text-gray-500">MERN Stack Developer</p>
                    </div>
                </div>
            </section>
            {blogsData.length === 0 && <img className='m-auto pb-20' src={spinner} alt="" />}
