                ...
                <div class="container px-6 py-4 mx-auto">
                    <div class="lg:flex">
                        <div class="w-full -mx-6 lg:w-2/5">
                            <div class="px-6">
                                <div>
                                    <a href="#" class="text-xl font-bold text-gray-300 dark:text-white hover:text-gray-500 dark:hover:text-gray-500">Brand</a>
                                </div>

                                <p class="max-w-md mt-2 text-gray-300 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, nisi! Id.</p>

                                <div class="flex mt-4 -mx-2">
                                    <a href="#" class="mx-2 text-gray-300 dark:text-gray-200 hover:text-gray-500 dark:hover:text-gray-500" aria-label="Linkden">
                                    ...
                                    <a href="#" class="mx-2 text-gray-300 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Facebook">
                                        <svg class="w-4 h-4 fill-current" viewBox="0 0 512 512">
                                            <path d="M455.27,32H56.73A24.74,24.74,0,0,0,32,56.73V455.27A24.74,24.74,0,0,0,56.73,480H256V304H202.45V240H256V189c0-57.86,40.13-89.36,91.82-89.36,24.73,0,51.33,1.86,57.51,2.68v60.43H364.15c-28.12,0-33.48,13.3-33.48,32.9V240h67l-8.75,64H330.67V480h124.6A24.74,24.74,0,0,0,480,455.27V56.73A24.74,24.74,0,0,0,455.27,32Z" />
                                        </svg>
                                    </a>

                                    <a href="#" class="mx-2 text-gray-300 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" aria-label="Twitter">
                                        <svg class="w-4 h-4 fill-current" viewBox="0 0 512 512">
                        ...
                        <div class="mt-6 lg:mt-0 lg:flex-1">
                            <div class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-4">
                                <div>
                                    <h3 class="text-gray-300 uppercase dark:text-white">About</h3>
                                ...
                                <div>
                                    <h3 class="text-gray-300 uppercase dark:text-white">Blog</h3>
                                ...
                                <div>
                                    <h3 class="text-gray-300 uppercase dark:text-white">Products</h3>
                                ...
                                <div>
                                    <h3 class="text-gray-300 uppercase dark:text-white">Contact</h3>
                    ...
                    <div>
                        <p class="text-center text-gray-300 dark:text-white">© Brand 2020 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </div>
